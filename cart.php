...
<h2> Checkout </h2>
<p>Please fill out the following and proceed to checkout.</p>
<div class="row">
  <div class="col-75">
    <div class="container">
      <form action="/action_page.php">
        ...
        <label>
          <input type="checkbox" checked=" not checked" name="sameadr"> Shipping address same as billing
        </label>
